...
export const ProductDetail = () => {
  ...
  return (
     ...
     <main>
        <section>
          <h1 className="mt-10 mb-5 text-4xl text-center font-bold text-black dark:text-slate-200">{product.name}</h1>
          <p className="mb-5 text-lg text-center text-black dark:text-slate-200">{product.overview}</p>
          <div className="flex flex-wrap justify-around">
            ...
            <p className="text-lg text-black dark:text-slate-200">
            {product.overview}
            </p>
            </div>
          </div>
